...
public class ShoppingList extends AppCompatActivity implements ShoppingListAdapter.ItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Ingredient burger3 = new Ingredient("Ice Cream", null, "freezer", (float)2.3, "4 lbs", "Dairy", "s");
        Ingredient burger4 = new Ingredient("Ice Cream", null, "freezer", (float)2.3, "4 lbs", "Dairy", "s");
        Ingredient burger5 = new Ingredient("Ice Cream", null, "freezer", (float)2.3, "4 lbs", "Dairy", "s");
        Ingredient burger6 = new Ingredient("Ice Cream", null, "freezer", (float)2.3, "4 lbs", "Dairy", "s");
        ...
        Button t = (Button) findViewById(R.id.shopSortDescription);
